...
class BlogPost(db.Model,UserMixin):
   __searchable__ =['author', 'title','sub_title','content','today']
...
def result():
   ...
   searchresults = BlogPost.query.msearch(searchword, fields=['author', 'title','sub_title','content','today'], limit =100 )
   return render_template('result.html', searchresults=searchresults, searchword=searchword)
